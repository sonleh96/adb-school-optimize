            ...
            <article className="methodology-doc">
              ...
              <section>
                ...
                <p>
                  ...
                  theoretical framework, select indicators that correspond to that framework, normalize
                  variables measured on different scales, document the weighting and aggregation rules, and
                  test the robustness of rankings to alternative assumptions. OECD and the European
                  Commission’s Joint Research Centre recommend exactly this sequence for policy-facing
                  composite indicators. The same sources also stress that results can change depending on
                  normalization, weighting, and aggregation choices, so these choices must be explicit and
                  reviewable.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  practice, education infrastructure decisions are rarely driven by one measure alone. They
                  usually depend on a combination of:
                </p>
                <ul className="methodology-list">
                  ...
                  <li>
                    implementation realities such as geographic coverage, policy relevance, or readiness.
                  </li>
                </ul>
                <p>
                  ...
                  accessibility conditions, and the wider area of influence of an education project rather
                  than evaluating a school in isolation. It is also consistent with more recent UNESCO
                  guidance that uses geospatial multi-criteria methods to assess natural-hazard risks in
                ...
                <p>
                  This separation is important because the school with the greatest deprivation is not always
                  the first one that a programme can or should fund. A transparent system should distinguish{" "}
              ...
              <section>
                ...
                <p>
                  ...
                  variables derived from geospatial or district-level sources. This is consistent with
                  UNESCO’s school-age-population methodology and related geospatial education-planning work,
                  which show that spatialized population and contextual data can be used to strengthen
                  planning where conventional information systems are weak or outdated.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  These indicators capture the potential size of the affected student population or pressure
                  on the school system. Depending on data availability, they may include enrollment, estimated
                  ...
                  projected demand, including population by age group and the location of the affected
                  population.
                </p>
                ...
                <p>
                  ...
                  required to provide adequate education. Typical examples include classroom shortages, poor
                  building conditions, lack of permanent structures, weak WASH coverage, or missing support
                  spaces. Global guidance from WHO and UNICEF emphasizes that safe water, toilets, and
                  handwashing facilities are fundamental to healthy and inclusive learning environments, while
                  the World Bank’s RIGHT+ framework places resilience, inclusiveness, health, and
                  teaching-and-learning functionality at the center of education-facility investment
                  decisions.
                </p>
                ...
                <p>
                  ...
                  Bank both emphasize that school planning and rehabilitation should account for natural
                  hazards and climate resilience, not just present-day service coverage.
                </p>
                ...
                <p>
                  ...
                  sequencing. Examples may include programme readiness, geographic balancing rules, policy
                  focus areas, or other operational criteria defined by the implementing agency. These
                  variables belong in the <strong>Priority score</strong>, not the <strong>Need score</strong>
                  .
                </p>
                <p>
                  <strong>
              ...
              <section>
                ...
                <p>
                  The module first reconciles school identifiers and geographies so that school-level records
                  can be joined with contextual layers. This may include matching school names, coordinates,
                ...
                <p>
                  Indicators where higher values imply better conditions are reversed before aggregation so
                  that all normalized indicators point in the same conceptual direction.
                </p>
                ...
                <p>
                  ...
                  empirical basis for doing so. In school datasets, a missing value can mean “unknown,” not
                  zero, and mechanical imputation can create false precision.
                </p>
                <p>
                  The OECD/JRC handbook treats missing-data imputation as a distinct methodological step that
                  materially affects rankings and therefore must be documented and tested. For this reason,
                  the recommended default for this module is:
                </p>
                <ul className="methodology-list">
              ...
              <section>
                ...
                <p>
                  ...
                  composite-indicator construction and notes that different normalization methods can yield
                  different results.
                </p>
                <p>
                ...
                <p>
                  ...
                  configuration so that scores remain stable across reruns unless the programme intentionally
                  recalibrates the model.
                </p>

                <h3>6.2 Outlier Handling</h3>
                <p>
                  If indicators contain strong outliers, the implementation may winsorize or cap extreme
                  values before normalization. This should be documented because OECD/JRC guidance notes that
              ...
              <section>
                ...
                <p>
                  The app’s <strong>default weights are programme parameters</strong>, not universal truths.
                  They are therefore stored outside the code path as configuration so they can be reviewed and
                  adjusted. This follows composite-indicator good practice: weighting should be explicit,
                  theoretically grounded, and open to sensitivity testing rather than hidden inside
              ...
              <section>
                ...
                <ul className="methodology-list">
                  ...
                  <li>
                    by <strong>domain sub-scores</strong> to identify the specific reason a school scores
                    highly,
                  </li>
              ...
              <section>
                ...
                <p>
                  ...
                  rankings. This helps users understand whether the final prioritization is still primarily
                  driven by need or is being materially reshaped by strategic filters.
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  environment, or estimated school-age population. This is methodologically justified when the
                  objective is to approximate the environment in which the school operates, especially in
                  low-data contexts. UNESCO’s geospatial planning work explicitly supports combining school
                  locations with school-age population estimates and spatial contextual layers for educational
                  planning.
                </p>
                <p>
                  However, contextual indicators should be interpreted as{" "}
                  <strong>context around the school</strong>, not as direct measurements of the school
                  facility itself. The methodology therefore keeps them conceptually separate from observed
                  school-stock variables.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  This ensures that programme teams can revise assumptions without rewriting the scoring
                  logic.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="methodology-list">
                  ...
                  <li>
                    ...
                    <em>
                      Multi-criteria decision analysis for site classification: Assessing natural hazard risks
                      for planning the location of educational facilities
                    </em>
                    . IIEP-UNESCO.
                  </li>
                  <li>
                  ...
                  <li>
                    WHO and UNICEF. (2022).{" "}
                    <em>
                      Schools ill-equipped to provide healthy and inclusive learning environments for all
                      children
                    </em>
                    . Joint news release.
                  </li>
                  <li>
                    World Bank. (2016).{" "}
                    <em>Simplified Methodology for Educational Infrastructure Projects</em>.
                  </li>
                  <li>
                    World Bank. (2024).{" "}
                    <em>Building Safer and More Resilient Schools in a Changing Climate</em>.
                  </li>
                  <li>
                    World Bank. (2025).{" "}
                    <em>
